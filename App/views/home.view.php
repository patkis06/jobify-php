...
<section>
  <div class="container mx-auto p-4 mt-4">
    <div class="text-center text-3xl mb-4 font-bold border border-gray-300 p-3">Latest Opportunities</div>
          ...
          <div class="p-4">
            ...
            <ul class="my-4 bg-gray-100 p-4 rounded">
              ...
              <li class="mb-2">
                <strong>Tags:</strong>
                <?php
                $tags_array = explode(',', $listing->tags);
                $capitalized_tags = array_map('ucfirst', $tags_array);
                ?>
                <span><?= implode(', ', $capitalized_tags) ?></span>
              </li>
            </ul>
